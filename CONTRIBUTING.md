Contributing to CentralDataBase Core
============================

The CentralDataBase Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to centraldatabase-qt
...
[Translation Process](https://github.com/centraldatabasepay/centraldatabase/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the CentralDataBase Core project (and related
projects such as libsecp256k1), and is not to be confused with overall CentralDataBase
Network Protocol consensus changes.

Whether a pull request is merged into CentralDataBase Core rests with the project merge
...
Patches that change CentralDataBase consensus rules are considerably more involved than
...
Where a patch set proposes to change the CentralDataBase consensus, it must have been
...
The review process is normally fairly responsive on the CentralDataBase Core repository, however
...
The project leader is the release manager for each CentralDataBase Core release.
