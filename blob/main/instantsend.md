...
This mechanism has been integrated into Bitcore-Node-CentralDataBase which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/centraldatabasepay/insight-api-centraldatabase#web-socket-api](https://github.com/centraldatabasepay/insight-api-centraldatabase#web-socket-api)
* API: [https://github.com/centraldatabasepay/insight-api-centraldatabase#instantsend-transactions](https://github.com/centraldatabasepay/insight-api-centraldatabase#instantsend-transactions)
