...
This document provides guidelines for internationalization of the CentralDataBase Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `centraldatabase_en.ts` remains unchanged.
