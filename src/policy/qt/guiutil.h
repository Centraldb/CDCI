...
/** Utility functions used by the CentralDataBase Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "centraldatabase:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load centraldatabase specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a centraldatabase specific theme is activated (light/dark).*/
