...
//! Interface for the src/evo part of a centraldatabase node (centraldatabased process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a centraldatabase node (centraldatabased process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a centraldatabase node (centraldatabased process).
...
//! Top-level interface for a centraldatabase node (centraldatabased process).
class Node
{
public:
    virtual ~Node() {}
