...
EXPECTED_HOLDER_NAMES = [
    ...
    "The CentralDataBase Core developers\n",
]
...
Arguments:
    <base_directory> - The base directory of a CentralDataBase Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The CentralDataBase Core developers'
...
Arguments:
    <base_directory> - The base directory of CentralDataBase Core source code repository.
"""
...
Arguments:
    <file> - A source file in the CentralDataBase Core repository.
"""
