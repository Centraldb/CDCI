...
# TestP2PConn: A peer we use to send messages to centraldatabased, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes centraldatabased to (reasonably!) disconnect us, so do this last.
    ...
    # centraldatabased's choice of nonce.
    ...
    # Test that centraldatabased requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for centraldatabased to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # centraldatabased will not send blocktxn responses for blocks whose height is
