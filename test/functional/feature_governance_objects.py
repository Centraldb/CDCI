...
"""Tests around centraldatabase governance objects."""
...
class CentralDataBaseGovernanceTest (CentralDataBaseTestFramework):
    def set_test_params(self):
        self.set_centraldatabase_test_params(2, 1)
...
if __name__ == '__main__':
    CentralDataBaseGovernanceTest().main()
