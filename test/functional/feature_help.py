...
"""Verify that starting centraldatabased with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start centraldatabased with -h for help text")
        ...
        self.log.info("Start centraldatabased with -version for version information")
